...
class PlantelController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request){
            ...
            ->paginate(16);
            return view ('admin.plantel.index',["planteles"=>$planteles,"searchTextp"=>$query]);   
    ...
    public function store(PlantelFormRequest $request)
    {
            ...
            $plantel->save();
            return Redirect::to('admin/plantel');
    }
    ...
    {
        return view('admin.plantel.show',["plantel"=>Plantel::findOrFail($id)]);
    }
    ...
    {
        return view('admin.plantel.edit',["plantel"=>Plantel::findOrFail($id)]);
    }
