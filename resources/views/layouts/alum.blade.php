  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
     <a href= "javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-table"></i>Evaluacion|Encuesta <i class="fa fa-fw fa-caret-down"></i></a>
      <ul id="demo" class="collapse">
       <li>
          <a href="{{ url('Alumnos/Alumno')}}">Evaluacion Docente</a>
        </li>
        <li>
        <a href="{{ url('Alumnos/AlumnoAdmin')}}">Evaluacion Adminisrativa</a>
        </li>
        </ul>
   </li>
