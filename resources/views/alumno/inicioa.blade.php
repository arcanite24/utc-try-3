    ...
    <div class="row">
        <div class="board">
            <ul class="nav nav-tabs">
                ...
                <li rel-index="1">
                    <a href="#step-2" class="btn" aria-controls="step-2" role="tab" data-toggle="tab">
                ...
                <li rel-index="3">
                    <a href="#step-4" class="btn" aria-controls="step-4" role="tab" data-toggle="tab">
                        ...
                        <?php $c=0; $s=0; ?>
                         ...
                         @if ( $pg->id_grupos == Session::get('id_grupo') )
                            ...
                            @if ( $pru->id_profesores == $pg->id_profesores && $pru->id_alumno == Session::get('matricula') )
                                ...
                                <tr class="bg-success">
                                    <td style="text-align: center; font-size: 14px;">{{ $pf->name }}</td>
...
<table class="table table-striped table-bordered table-hover table-condensed">
    ...
    <tbody>
        ...
        <tr> <?php $op=false; ?> 
            @foreach($materias as $ma)
                ...
                <td class="success">{{ $ma->descripcionm }}</td>
                    ...
                    <td style="text-align: center;" @if($cal->parcial1<6) class="bg-danger" @else class="success" @endif>{{ $cal->parcial1 }}</td> 
                    <td style="text-align: center;" @if($cal->parcial2<6) class="bg-danger" @else class="success" @endif>{{ $cal->parcial2 }}</td> 
                    <td style="text-align: center;" @if($cal->parcial3<6) class="bg-danger"  @else class="success" @endif>{{ $cal->parcial3 }}</td> 
        ...
        <tr class="success">
            ...
            <td style="text-align: center;"><b><i>{{ number_format($promediofinal, 2, '.', '') }}</i></b></td>
        </tr>
    </tbody>
</table>
</div> 
