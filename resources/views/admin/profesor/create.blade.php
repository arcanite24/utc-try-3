...
{!!Form::open(array('url'=>'admin/profesor','method'=>'POST','autocomplete'=>'off'))!!}
			{{Form::token()}}
			<div class="row">
...
<div class="form-group col-lg-4 col-sm-4 col-md-4 col-xs-12">
	...
	<div class="col-lg-8">
		<a href="/admin/administrador/profesor"><button class="btn btn-sm btn-success" type="button">Regresar a pagína anterior</button></a>
			</div>				
